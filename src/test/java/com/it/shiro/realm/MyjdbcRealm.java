...
public class MyjdbcRealm extends AuthorizingRealm {
     ...
     */
    protected static final String DEFAULT_AUTHENTICATION_QUERY = "select password from sys_users where username = ?";
    ...
    protected JdbcRealm.SaltStyle saltStyle = JdbcRealm.SaltStyle.NO_SALT;
    ...
    public void setSaltStyle(JdbcRealm.SaltStyle saltStyle) {
        ...
        if (saltStyle == JdbcRealm.SaltStyle.COLUMN && authenticationQuery.equals(DEFAULT_AUTHENTICATION_QUERY)) {
